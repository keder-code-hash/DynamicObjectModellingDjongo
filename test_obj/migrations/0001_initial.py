# Generated by Django 3.1.14 on 2022-07-01 16:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('_id', djongo.models.fields.ObjectIdField(auto_created=True, primary_key=True, serialize=False)),
                ('test_embed', test_obj.models.EmbeddedDocument(model_container=test_obj.models.TestAbs)),
                ('test_array', test_obj.models.ArrayDocument(model_container=test_obj.models.TestAbs)),
            ],
            options={
                'db_table': 'TestEmbed',
            },
