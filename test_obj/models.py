...
from djongo.models.fields import EmbeddedField,FormedField,ModelField
...
class CustomFormedField(FormedField):
    def __init__(self,
...
class EmbeddedField(CustomFormedField):
    def __init__(self,
                 model_container: typing.Type[Model],
                 model_form_class: typing.Type[forms.ModelForm] = None,
                 model_form_kwargs: dict = None,
...
class ArrayField(models.ArrayField):
    def __init__(self,
                 model_container: typing.Type[Model],
                 model_form_class: typing.Type[forms.ModelForm] = None,
                 model_form_kwargs: dict = None,
                 *args, **kwargs):
        super().__init__(model_container, *args, **kwargs) 
        self.FormedFieldObj = CustomFormedField(model_container=self.model_container)
    ...
    def _save_value_thru_fields(self,
        ...
        for pre_dict in value:
            post_dict = self.FormedFieldObj._save_value_thru_fields(func_name,
                                                        pre_dict,
                                                        *other_args)
...
class TestAbs(models.Model):
    ...
    desc2 = models.CharField(max_length=30)
...
class TestEmbed(models.Model):
    _id = models.ObjectIdField()
    test_embed = EmbeddedField(model_container=TestAbs)
    test_array = ArrayField(model_container=TestAbs)
